...
file = reader(open(r'C:\Users\User\Desktop\GIT AIT Akbar\October\users.csv'))

table = list(reader(open(r'C:\Users\User\Desktop\GIT AIT Akbar\October\mbank_short.csv')))
table = table[1:]
...
file = reader(open(r'C:\Users\User\Desktop\GIT AIT Akbar\October\currencies.csv'))
currencies = {}
for i in file:
    if len(i) >0:
        currencies[i[0]] = i[1]
...
def get_from_to(from_id,to_id):
    ...
    return ''
print(get_from_to('Gulnur Satylganova','Emil Bilgazyev'))
